...
CREATE TABLE `qcc` (
  ...
  `business_status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '经营状态',
  `establishment_date` datetime DEFAULT NULL COMMENT '成立日期',
  `registered_capital` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '注册资本',
  `paid_in_capital` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '实缴资本',
  ...
  `organization_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '组织机构代码',
  `business_registration_no` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '工商注册号',
  `taxpayer_registration_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '纳税人识别号',
  `import_export _enterprise_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '进出口企业代码',
  `industry` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '所属行业',
  `business_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '企业类型',
  `business_term` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '营业期限',
  ...
  `staff_insured` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '参保人数',
  `area` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '所属地区',
  `old_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '曾用名',
  `english_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '英文名',
  `business_address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '企业地址',
...
CREATE TABLE `qcc_administrative_license` (
  ...
  `license_date` datetime DEFAULT NULL COMMENT '决定日期',
...
-- ----------------------------
-- Table structure for qcc_legal_proceeding
-- ----------------------------
DROP TABLE IF EXISTS `qcc_legal_proceeding`;
CREATE TABLE `qcc_legal_proceeding` (
  `id` int NOT NULL,
  `enterprise_id` int DEFAULT NULL,
...
-- ----------------------------
-- Records of qcc_legal_proceeding
-- ----------------------------
BEGIN;
COMMIT;
...
CREATE TABLE `qcc_qualification_certificate` (
  ...
  `closing_date` datetime DEFAULT NULL COMMENT '截止日期',
  `gmt_create` datetime DEFAULT CURRENT_TIMESTAMP,
  `gmt_modify` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `status` int DEFAULT '1',
  PRIMARY KEY (`id`)
...
CREATE TABLE `qcc_shareholder` (
  ...
  `subscribed_capital_date` datetime DEFAULT NULL COMMENT '认缴出资日期',
  `paid_capital` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '实缴出资额(万元)',
  `paid_capital_date` datetime DEFAULT NULL COMMENT '实缴出资日期',
  `gmt_create` datetime DEFAULT CURRENT_TIMESTAMP,
  `gmt_modify` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `status` int DEFAULT '1',
  PRIMARY KEY (`id`)

...
public class QccAnnualReportDTO {
    ...
    private List<QccAnnualReportShareholder> shareholderList;
    ...
    public List<QccAnnualReportShareholder> getShareholderList() {
        return shareholderList;
    }

    public void setShareholderList(List<QccAnnualReportShareholder> shareholderList) {

...
public interface SaveJson {
    ...
    void saveJsonAmerica4Mississippi(File fileDirPath) throws Exception;

    void saveJsonAmerica4Michigan(File fileDirPath) throws Exception;

    void saveJsonAmerica4Massachusetts(File fileDirPath) throws Exception;

    void readJsonFrance(File fileDirPath) throws Exception;

    void saveJsonAmerica4Colorado(File fileDirPath) throws Exception;

    void saveJsonAmerica4Kentucky(File fileDirPath) throws Exception;

    void saveJsonAmerica4California(File fileDirPath) throws Exception;

    void saveJsonAmerica4Maine(File fileDirPath) throws Exception;

    void saveJsonAmerica4Idaho(File fileDirPath) throws Exception;

    void saveJsonAmerica4Connecticut(File fileDirPath) throws Exception;

    void saveJsonChinaEc(File fileDirPath) throws Exception;

    void saveJsonAmerica4Arkansas(File fileDirPath) throws Exception;

    void saveJsonAmerica4Utah(File fileDirPath) throws Exception;

    void saveJsonAmerica4Vermount(File fileDirPath) throws Exception;

    void saveJsonAmerica4Virginia(File fileDirPath) throws Exception;

    void saveJsonAmerica4Washington(File fileDirPath) throws Exception;

    void saveJsonAmerica4Louisiana(File fileDirPath) throws Exception;

    void saveJsonAmerica4Iowa(File fileDirPath) throws Exception;
